    ...
    <header class="header position-absolute">
        <div class="header__top">
            ...
            <nav id="nav" class="header__top__navigation">
                <div class="navigation-tab" id="navigation-tab-1">
                    <a class="open text-uppercase" href="/fashion" aria-label="FASHION &amp; ACCESSORIES" target="_self" rel="" tabindex="1" data-end-to-end="auto_menu_tab_fashion">FASHION &amp; ACCESSORIES</a>
                </div>
                <div class="navigation-tab" id="navigation-tab-2">
                    <a class="open text-uppercase" href="/beauty" aria-label="FRAGRANCE &amp; BEAUTY" target="_self" rel="" tabindex="1" data-end-to-end="auto_menu_tab_beauty">FRAGRANCE &amp; BEAUTY</a>
                </div>
            </nav>
            <!-- Middle -->
            <a href="/beauty" class="header__top__logo position-absolute">
        ...
        <div class="header__menu-placeholder h-0" id="header__menu-placeholder-1">
            <div class="navigation-tab-second text-uppercase" id="navigation-tab-second-1">
                <a href="/womens-fashion/woman" aria-label="Women's Fashion" target="_self" rel="" tabindex="-1" data-end-to-end="auto_menu_level2_item_69279">Women's Fashion</a>
            </div>
            <div class="navigation-tab-second text-uppercase" id="navigation-tab-secon-2">
                <a href="/mens-fashion/man" aria-label="Men's Fashion" target="_self" rel="" tabindex="-1" data-end-to-end="auto_menu_level2_item_69538">Men's Fashion</a>
            </div>
            <div class="navigation-tab-second text-uppercase" id="navigation-tab-second-3">
                <a href="/kids/kids-fashion" aria-label="KIDS &amp; BABY" target="_self" rel="" tabindex="-1" data-end-to-end="auto_menu_level2_item_69628">KIDS &amp; BABY</a>
            </div>
        </div>
        ...
        <div class="header__menu-placeholder h-0" id="header__menu-placeholder-2">
            <div class="navigation-tab-second text-uppercase" id="navigation-tab-second-4">
                <a href="/womens-fragance/new" aria-label="Women's Fragrance" target="_self" rel="" tabindex="-1" data-end-to-end="auto_menu_level2_item_146619">Women's Fragrance</a>
            </div>
            <div class="navigation-tab-second text-uppercase" id="navigation-tab-second-5">
                <a href="/mens-fragance/new" aria-label="Men's Fragrance" target="_self" rel="" tabindex="-1" data-end-to-end="auto_menu_level2_item_146623">Men's Fragrance</a>
            </div>
            <div class="navigation-tab-second text-uppercase" id="navigation-tab-second-6">
                <a href="/skincare/new-skincare" aria-label="Skincare" target="_self" rel="" tabindex="-1" data-end-to-end="auto_menu_level2_item_45679">Skincare</a>
            </div>
        </div>

    </header>
    <div class="header__menu-placeholder-second"></div>
</div>
